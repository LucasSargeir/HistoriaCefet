						...
						<div class="inner">
							...
							<?php
								...
								if ($id and $idt){
									...
									$resposta = mysqli_query($link, "select * from textoaluno where idP = '$id' and id_textoA = '$idt'");
									...
									if ($resposta){
										...
										if ($linha){
											echo"<form name='form' method='post' action='editarTAp.php' enctype='multipart/form-data'>
												<h4>Nome</h4>
											<div class='row uniform'>
												...
												echo"<h4>Autor</h4>
												<div class='12u$'>
												<input type='text' name='aluno' id='aluno' value='$linha[nomeA]' placeholder='Nome do Aluno' required='' />
												</div></div>";
											...
											$id=$_SESSION['usuario']; echo "<input type='hidden' name='id' value='$linha[id_textoA]'>
											<br>
