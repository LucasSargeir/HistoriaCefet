						...
						<div class="inner">
							...
							<?php
								...
								if ($id and $idv){
									...
									$resposta = mysqli_query($link, "select * from video where idP = '$id' and id_video = '$idv'");
									...
									if ($resposta){
										...
										if ($linha){
											echo"<section>
												<form name='form' method='post' action='editarVp.php' enctype='multipart/form-data'>
												<h4>Nome</h4>
											<div class='row uniform'>
												<div class='6u 12u$(xsmall)'>
													<input type='text' name='titulo' id='nome' value='$linha[titulo]' placeholder='Nome' required='' />
												</div>";
											...
											$id=$_SESSION['usuario']; echo "<input type='hidden' name='id' value='$linha[id_video]'>
											<br>
									        <button type='submit' accesskey='S' name='sbmSalvar' class='infraButton'><span class='infraTeclaAtalho'>E</span>nviar</button><br>
									</form>
