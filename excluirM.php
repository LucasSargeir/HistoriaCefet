								...
								<section>
									...
									<form name="form" method="post" action="cTexto.php" enctype="multipart/form-data">
									    <fieldset class="infraFieldset">
									        <h2 class="infraLegend">Todas as matéria</h2>
									        <h3>Clique nos nomes para excluir (Quando uma matéria for excluido ele não será recuperado)</h3>
											<?php
												...
												if($resposta3){	
													...
													if($linha3['admin']){
														...
														if($resposta2){	
															...
															while($linha2){		
																echo"<a href='excluirMa.php?id={$linha2['id_materia']}'>{$linha2['nome']}</a>&nbsp;&nbsp;&nbsp;&nbsp;";
																$linha2 = mysqli_fetch_assoc($resposta2);
															}
														}
													}
