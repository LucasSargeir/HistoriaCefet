							...
							<!-- Content -->
								<section>
									<header class="main">
										...
										<form method="post" action="textoTA.php">
										...
										<?php
											if(isset($_REQUEST['materia']) || isset($_REQUEST['titulo'])){
												...
												//echo"$sql";
												$resposta = mysqli_query($link, $sql." and aluno = 1 order by id_textoA desc");
												...
												if($resposta){
													...
													while($linhaTextos){
														...
														echo "<article >
															...
															<b>Aluno(s):</b> {$linhaTextos['nomeA']} <br><br>
																    {$linhaTextos['resumo']} 
															</div>
																<br>

																<ul class='actions'>
																	<li><a href='texto.php?id={$linhaTextos['id_textoA']}&aluno=1' class='button special'>Mais</a></li>
																</ul></article>";
												...
												$linhaTextos = recebeTextosA($pagT,16,"textoaluno","id_textoA","aluno = 1 and", $link);

												echo"<header class='major'>
														<h2>Textos dos Alunos</h2>
													</header><div class='posts' >";
												...
												for ($i=0; $i < count($linhaTextos); $i++) { 
													...
													echo"</h6></div>
													<div style='overflow: hidden; width:25em; border:1px; text-overflow: ellipsis;  white-space:nowrap;'>
														    <b>Aluno(s):</b> {$linhaTextos[$i]['nomeA']} <br><br>
														    {$linhaTextos[$i]['resumo']} 
													</div>
														<br>

														<ul class='actions'>
															<li><a href='texto.php?id={$linhaTextos[$i]['id_textoA']}&aluno=1' class='button special'>Mais</a></li>
														</ul></article>";
												}
												}
												...
												$bla = 1;
												$totalObj = mysqli_num_rows(mysqli_query($link, "select * from textoaluno where aluno = $bla"));
												...
												if($pagT == 1 ){
													...
													$sub = $pagT - 1;
													echo" <li><a href='textoTA.php?pagT=$sub' class='button'>Voltar</a></li>";
												...
												for ($i=1; $i <= $numPag ; $i++) { 
													if( $i == $pagT){
														...
														echo"<li><a href='textoTA.php?pagT=$i' class='page active'>$i</a></li>";

													}else{

														echo"<li><a href='textoTA.php?pagT=$i' class='page'>$i</a></li>";
												...
												if($pagT == $numPag ){
													...
													$som = $pagT + 1;
													echo" <li><a href='textoTA.php?pagT=$som' class='button'>Próximo</a></li>";
